...
function require(path, parent, orig) {
    ...
    if (null == resolved) {
        ...
        parent = parent || 'root';
        var err =
            new Error('Failed to require "' + orig + '" from "' + parent + '"');
        err.path = orig;
        err.parent = parent;
        err.require = true;
        throw err;
...
require.register(
    'node-pinus-pinus-protocol/lib/protocol.js',
    function(exports, require, module) {
        (function(exports, ByteArray, global) {
            ...
            Protocol.strencode = function(str) {
                ...
                for (var i = 0; i < str.length; i++) {
                    ...
                    if (charCode <= 0x7f) {
                        ...
                        codes = [
                            0xe0 | (charCode >> 12), 0x80 | ((charCode & 0xfc0) >> 6),
                            0x80 | (charCode & 0x3f)
                        ];
                    }
            ...
            Protocol.strdecode = function(buffer) {
                ...
                while (offset < end) {
                    if (bytes[offset] < 128) {
                        ...
                        charCode =
                            ((bytes[offset] & 0x3f) << 6) + (bytes[offset + 1] & 0x3f);
                        offset += 2;
                    } else {
                ...
                for (i = 0; i < array.length / chunk; i++) {
                    res += String.fromCharCode.apply(
                        null, array.slice(i * chunk, (i + 1) * chunk));
                }
             ...
             * @return {Object}           {type: package type, buffer: body byte
             *     array}
             */
            Package.decode = function(buffer) {
                ...
                var type = bytes[0];
                var index = 1;
                var length = ((bytes[index++]) << 16 | (bytes[index++]) << 8 |
                        bytes[index++]) >>>
                    0;
            ...
            var msgHasRoute = function(type) {
                return type === Message.TYPE_REQUEST ||
                    type === Message.TYPE_NOTIFY || type === Message.TYPE_PUSH;
            };
            ...
            'object' === typeof module ? Buffer : Uint8Array, this);
    });
require.register(
    'pinusnode-pinus-protobuf/lib/client/protobuf.js',
    function(exports, require, module) {
        ...
        (function(exports, global) {
            ...
            Protobuf.init = function(opts) {
                // On the serverside, use serverProtos to encode messages send to
                // client
                Protobuf.encoder.init(opts.encoderProtos);

                // On the serverside, user clientProtos to decode messages receive
                // from clients
        ...
        })('object' === typeof module ? module.exports : (this.protobuf = {}),
            this);
        ...
        (function(exports, global) {
            ...
            Util.isSimpleType = function(type) {
                return (
                    type === 'uInt32' || type === 'sInt32' || type === 'int32' ||
                    type === 'uInt64' || type === 'sInt64' || type === 'float' ||
                    type === 'double');
            };
        })('undefined' !== typeof protobuf ? protobuf : module.exports, this);
        ...
        (function(exports, global) {
                        ...
                        case 'repeated':
                            ...
                            if (!!msg[name] && !!protos.__messages[proto.type]) {
                                for (var i = 0; i < msg[name].length; i++) {
                                    if (!checkMsg(
                                            msg[name][i], protos.__messages[proto.type])) {
                                        return false;
                                    }
                                }
                            }
                ...
                for (var name in msg) {
                    if (!!protos[name]) {
                        ...
                        switch (proto.option) {
                            ...
                            case 'optional':
                                offset = writeBytes(
                                    buffer, offset, encodeTag(proto.type, proto.tag));
                                offset =
                                    encodeProp(msg[name], proto.type, offset, buffer, protos);
                                break;
                            case 'repeated':
                                if (msg[name].length > 0) {
                                    offset =
                                        encodeArray(msg[name], proto, offset, buffer, protos);
                                }
                                break;
                        }
                    }
                ...
                switch (type) {
                    ...
                    default:
                        if (!!protos.__messages[type]) {
                            ...
                            var tmpBuffer =
                                new ArrayBuffer(codec.byteLength(JSON.stringify(value)));
                            var length = 0;

                            length = encodeMsg(
                                tmpBuffer, length, protos.__messages[type], value);
                            // Encode length
                            offset = writeBytes(buffer, offset, codec.encodeUInt32(length));
                            // contact the object
            ...
            /**
             * Encode reapeated properties, simple msg and object are decode
             * differented
             */
            function encodeArray(array, proto, offset, buffer, protos) {
                ...
                if (util.isSimpleType(proto.type)) {
                    offset =
                        writeBytes(buffer, offset, encodeTag(proto.type, proto.tag));
                    offset =
                        writeBytes(buffer, offset, codec.encodeUInt32(array.length));
        ...
        (function() {
            ...
            var heartbeat = function(data) {
                ...
                heartbeatId = setTimeout(function() {
                    ...
                    nextHeartbeatTimeout = Date.now() + heartbeatTimeout;
                    heartbeatTimeoutId =
                        setTimeout(heartbeatTimeoutCb, heartbeatTimeout);
                }, heartbeatInterval);
            };
            ...
            var onKick = function(data) {
                console.log("pinus on kick !!!!!", data)
                pinus.emit('onKick');
            };
            ...
            var handshakeInit = function(data) {
                if (data.sys && data.sys.heartbeat) {
                    heartbeatInterval =
                        data.sys.heartbeat * 1000; // heartbeat interval
...
require.alias(
    'component-indexof/index.js', 'component-emitter/deps/indexof/index.js');

require.alias(
    'node-pinus-pinus-protocol/lib/protocol.js',
    'boot/deps/pinus-protocol/lib/protocol.js');
require.alias(
    'node-pinus-pinus-protocol/lib/protocol.js',
    'boot/deps/pinus-protocol/index.js');
require.alias(
    'node-pinus-pinus-protocol/lib/protocol.js',
    'node-pinus-pinus-protocol/index.js');

require.alias(
    'pinusnode-pinus-protobuf/lib/client/protobuf.js',
    'boot/deps/pinus-protobuf/lib/client/protobuf.js');
require.alias(
    'pinusnode-pinus-protobuf/lib/client/protobuf.js',
    'boot/deps/pinus-protobuf/index.js');
require.alias(
    'pinusnode-pinus-protobuf/lib/client/protobuf.js',
    'pinusnode-pinus-protobuf/index.js');
